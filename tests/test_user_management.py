...
def test_first_name_field(user_management):
...
def test_last_name_field(user_management):
...
def test_email_field(user_management):
...
def test_mob_no_field(user_management):
...
def test_country_field(user_management):
...
def test_state_field(user_management):
...
def test_usermanagement_status_field(user_management):
...
def test_usermanagement_new_flow(user_management):
    
    user_management.new_flow()
    
def test_usermanagement_update_flow(user_management):
